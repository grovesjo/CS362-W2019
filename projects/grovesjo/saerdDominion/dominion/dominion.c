...
int playAdventurer(struct gameState * state)
{
    ...
    // The following line is the corrected code
    maxCards = state->deckCount[currentPlayer] + state->discardCount[currentPlayer];
...
int playSmithy(struct gameState * state, int handPos)
{
    ...
    //+3 Cards
    // Correcting below code from for(i = 0; i <= 3; i++)
    for (i = 0; i < 3; i++)
	    drawCard(currentPlayer, state);
